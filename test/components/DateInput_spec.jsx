...
describe('DateInput', () => {
  describe('#render', () => {
    describe('input', () => {
      it('has props.ariaLabel as an aria-label if ariaLabel is passed in', () => {
        ...
        const wrapper = shallow(
          <DateInput id='date' ariaLabel={ariaLabel} />
        ).dive();
      ...
      it('has no aria-label if props.ariaLabel is null', () => {
        const wrapper = shallow(
          <DateInput id='date' ariaLabel={null} />
        ).dive();
      ...
      it('has props.titleText as a title attribute if titleText is passed in', () => {
        ...
        const wrapper = shallow(
          <DateInput id='date' titleText={titleText} />
        ).dive();
      ...
      it('has no title attribute if props.titleText is null', () => {
        const wrapper = shallow(
          <DateInput id='date' titleText={null} />
        ).dive();
    ...
    it('renders a label element if labelText is passed in', () => {
      const labelText = 'Select a Date';
      const wrapper = shallow(
        <DateInput id='date' labelText={labelText} />
      ).dive();
      expect(wrapper.find('label').text()).to.equal(labelText);
    });

    it('does not render a label element if labelText is not passed in', () => {
      const wrapper = shallow(<DateInput id='date' />).dive();
  ...
  describe('#componentWillReceiveProps', () => {
    describe('nextProps.displayValue exists', () => {
      it("sets state.dateString to ''", () => {
        ...
        wrapper
          .instance()
          .componentWillReceiveProps({ displayValue: '1991-07-13' });
